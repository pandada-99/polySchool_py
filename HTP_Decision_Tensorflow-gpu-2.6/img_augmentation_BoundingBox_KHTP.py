...
if __name__ == '__main__':
    for i in range(1, 66):
        img = cv2.imread('data/KHTP/book/book_KHTP_' + str(i) + '.png')
        img_w = img.shape[1]
        img_h = img.shape[0]

        with open("data/KHTP/book/book_KHTP_" + str(i) + ".txt", "r") as f:
            box = f.read().split()
        ...
        cv2.imwrite("data/KHTP/book_aug/book_KHTP_aug_s_" + str(i) + ".png", output_img_s[0])
        with open("data/KHTP/book_aug/book_KHTP_aug_s_" + str(i) + ".txt", "w") as f:
        ...
        cv2.imwrite("data/KHTP/book_aug/book_KHTP_aug_r_" + str(i) + ".png", output_img_r[0])
        with open("data/KHTP/book_aug/book_KHTP_aug_r_" + str(i) + ".txt", "w") as f:
        ...
        cv2.imwrite("data/KHTP/book_aug/book_KHTP_r2_" + str(i) + ".png", output_img_r2[0])
        with open("data/KHTP/book_aug/book_KHTP_aug_r2_" + str(i) + ".txt", "w") as f:
        ...
        cv2.imwrite("data/KHTP/book_aug/book_KHTP_aug_x_" + str(i) + ".png", output_img_x[0])
        with open("data/KHTP/book_aug/book_KHTP_aug_x_" + str(i) + ".txt", "w") as f:
        ...
        cv2.imwrite("data/KHTP/book_aug/book_KHTP_aug_x2_" + str(i) + ".png", output_img_x2[0])
        with open("data/KHTP/book_aug/book_KHTP_aug_x2_" + str(i) + ".txt", "w") as f:
        ...
        cv2.imwrite("data/KHTP/book_aug/book_KHTP_aug_y_" + str(i) + ".png", output_img_y[0])
        with open("data/KHTP/book_aug/book_KHTP_aug_y_" + str(i) + ".txt", "w") as f:
        ...
        cv2.imwrite("data/KHTP/book_aug/book_KHTP_aug_y2_" + str(i) + ".png", output_img_y2[0])
        with open("data/KHTP/book_aug/book_KHTP_aug_y2_" + str(i) + ".txt", "w") as f:
